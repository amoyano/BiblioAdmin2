...
/*
 * LibrosBuscarPorDisciplinaView.java
 *
 * Created on 04-may-2011, 19:33:13
 */
 ...
 */
public class LibrosBuscarPorDisciplinaView extends javax.swing.JFrame {

    /** Creates new form LibrosBuscarPorDisciplinaView */
    public LibrosBuscarPorDisciplinaView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(biblioadmin2.BiblioAdmin2App.class).getContext().getResourceMap(LibrosBuscarPorDisciplinaView.class);
        label3.setText(resourceMap.getString("label3.text")); // NOI18N

        txtDisciplina.setName("txtDisciplina"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(biblioadmin2.BiblioAdmin2App.class).getContext().getActionMap(LibrosBuscarPorDisciplinaView.class, this);
        jButton5.setAction(actionMap.get("buscarLibrosDisciplina")); // NOI18N
                    ...
                    .add(layout.createSequentialGroup()
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(layout.createSequentialGroup()
                                ...
                                .add(1, 1, 1)
                                .add(txtDisciplina, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE))
                            .add(layout.createSequentialGroup()
                                .add(292, 292, 292)
                                .add(jButton5)))
                        .addContainerGap())
    ...
    @Action
    public void buscarLibrosDisciplina() {
       ObjectSet<Libro> libros;


        libros  = LibroManager.getInstance().buscar(null, null, this.txtDisciplina.getText());
